...
def correct_station(
    station_id, obs_dir, raw_dir, output_dir, n_quantiles, models_dir=None
):
    ...
    print(
        f"  Station {station_id}: Saved {len(result_df)} values ({n_corrected} DQM corrected, {n_raw} raw)"
    )
...
def correct_all_stations(
    ...
    for station_id in stations:
        ...
        correct_station(
            station_id, obs_dir, raw_dir, output_dir, n_quantiles, models_dir
        )
